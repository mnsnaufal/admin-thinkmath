...
router.patch('/:id/updateUser', async (req, res) => {
    const { username, notlp, oldPassword, newPassword } = req.body;
    ...
    try {
        ...
        // Jika oldPassword dan newPassword diberikan, lakukan validasi
        ...
        // Update data lain seperti username dan notlp
        if (username) user.username = username;
        if (notlp) user.notlp = notlp;
